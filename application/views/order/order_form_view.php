...
<div class="container container-person mt-5 p-5">
    ...
    <table id="order_table" class="table table-striped table-bordered table-responsive-sm" style="width:100%">
        ...
        <?php if($products) { ?>
            ...
            <td class="text-center" colspan="4">No products in this order</td>
        <?php } ?>
        </tbody>
    </table>
    <div class="row">
    ...
    <div class="row">
        <div class="col-sm-12">
            <a href="#" data-id="<?=base_url('order/delete/'.$order_id)?>" class="btn btn-danger delete-order w-100 mt-5" data-toggle="modal" data-target="#deleteOrderModal">Delete</a>
        </div>
    </div>
</div>
